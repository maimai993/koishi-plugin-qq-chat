...
exports.Config = koishi_1.Schema.intersect([
    ...
    koishi_1.Schema.object({
        ...
        mobilePassword: koishi_1.Schema.string().role('secret').default('').description('手机端 App / 手机 API 的访问密码（留空则跟随上面的访问控制：启用 auth 时可用控制台登录态，否则无需密码）。设置后，手机 App、/qq-chat/api/* 与手机端页面都要求先输入这个密码'),
    }).description('访问控制'),
    koishi_1.Schema.object({
